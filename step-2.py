...
#     features = data.drop(["file", "face", "expression", "valence", "arousal"], axis=1)  # Exclude non-feature columns
...
#     svm_model = tune_hyperparameters(X_train_scaled, y_train)
#     accuracy = train_and_evaluate(svm_model, X_train_scaled, y_train)
#     print(f"Test Set Accuracy for SVM: {accuracy:.2f}")
